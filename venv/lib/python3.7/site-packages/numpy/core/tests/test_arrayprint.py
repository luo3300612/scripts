...
class TestPrintOptions(object):
    ...
    def test_floatmode(self):
        ...
        assert_equal(repr(w),
            ...
            "       1.e+16, 1.e+17, 1.e+chapter18, 1.e+19, 1.e+20, 1.e+21, 1.e+22, 1.e+23,\n"
            "       1.e+24])")
    ...
    def test_dtype_linewidth_wrapping(self):
        ...
        assert_equal(repr(np.arange(10,20., dtype='f4')),
            "array([10., 11., 12., 13., 14., 15., 16., 17., chapter18., 19.], dtype=float32)")
        assert_equal(repr(np.arange(10,23., dtype='f4')), textwrap.dedent("""\
            array([10., 11., 12., 13., 14., 15., 16., 17., chapter18., 19., 20., 21., 22.],
                  dtype=float32)"""))
